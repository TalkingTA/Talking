    ...
    <div class="divPadding">
      <div class="container">
        <div class="col-sm-6 col-md-6">
          <form class="navbar-form navbar-left" role="search" method="GET" action="../../php/metodos/metodosDisciplinas.php">
        ...
        <table class="table table-borderless">
          ...
          <tbody>
            ...
            <tr>   
              ...
              <td>
                <button type="button" name="excluir" class="btn btn-danger" class="btnExcluir" data-toggle="modal" data-target="#ModalExcluir<?php echo $dados[$i]['disciplina_id']; ?>">Excluir</button>
              </td>
            </tr>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>Descrição:<input type="text" name="descricao"   value="<?= $dados[$i]['disciplina_descricao']  ?>"></p>
        ...
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input class="input100" type="text" name="descricao" id="descricao" placeholder="Digite a descricao" required>
